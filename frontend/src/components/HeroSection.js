...
export default function HeroSection({ user, onLogout }) {
  ...
  return (
    <section className="w-full pt-32 pb-16 bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-500 dark:from-gray-900 dark:via-indigo-900 dark:to-blue-900">
